package xpertss.crypto.kms.crt;
...
public class SelfSignedCrtGenerator {
    ...
    public static String generate(KeyPair keyPair, String csr, KmsSigningAlgorithm kmsSigningAlgorithm, int validity) {
        ...
        try {
            ...
            return certOutputStream.toString(StandardCharsets.UTF_8.toString());
